                ...
                <div class="p-8">
                    <div class="mb-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <div
                                class="flex items-center gap-4 p-2 rounded-2xl bg-white dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 shadow-sm">
                                <input type="date" id="custom_date" max="{{ now()->toDateString() }}"
                                    class="bg-transparent border-none text-[10px] font-bold text-slate-900 dark:text-white focus:ring-0 cursor-pointer placeholder-slate-400 dark:placeholder-slate-500">
                                <button @click="markCustomDate()"
                                    class="px-4 py-2 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 rounded-xl text-[10px] font-black uppercase tracking-widest border border-indigo-500/20 transition-all">
                                    + Add Date
                                </button>
                            </div>
